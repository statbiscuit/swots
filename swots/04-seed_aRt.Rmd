...
![](http://etoan.com/random-number-generation/dilbert2001182781025.gif)

### [flametree](https://github.com/djnavarro/flametree)

Inspired by [Danielle Navarro](https://djnavarro.net/)'s [aRt](https://github.com/djnavarro) packages we illustrate, using art, what setting a random `seed` does.
